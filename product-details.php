...
<html lang="es">
	<head>
        ...
        <link href="assets/css/animate.css/bootstrap/css/bootstrap.min.css" rel="stylesheet">
							...
							<div class="product-social-link m-t-20 text-right">
								...
								<div class="social-icons">
						            <ul class="list-inline">
						                <li><a class="fa fa-facebook" href="https://web.facebook.com/maxishop.bog?_rdc=1&_rdr"></a></li>
						                <li><a class="fa fa-phone" href="https://api.whatsapp.com/send/?phone=573244302469&text&type=phone_number&app_absent=0"></a></li>
						                <li><a class="fa fa-google" href="https://web.facebook.com/maxishop.bog?_rdc=1&_rdr"></a></li>
						                <li><a class="fa fa-instagram" href="https://www.instagram.com/maxishop.bog/"></a></li>
						            </ul><!-- /.social-icons -->
						        </div>
							</div>
