...
<html lang="es">
	<head>
		...
		<link href="assets/css/animate.css/bootstrap.min.css" rel="stylesheet">
        <link href="assets/css/animate.css/bootstrap-icons/bootstrap-icons.css" rel="stylesheet">
        <link href="asset/css/animate.css/boxicons.min.css" rel="stylesheet">
        <link href="assets/css/animate.css/glightbox/css/glightbox.min.css" rel="stylesheet">
        <link href="assets/css/animate.css/swiper-bundle.min.css" rel="stylesheet">
...
<div id="hero" class="homepage-slider3">
	<div id="owl-main" class="carousel-item active">
		<div class="full-width-slider">	
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/imagen-0.jpeg);">
				<!-- /.container-fluid -->
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
	    
	    <div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/imagen-3.jpeg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->

		<div class="full-width-slider">
			<div class="item full-width-slider" style="background-image: url(assets/images/sliders/imagen0.jpeg);">
			</div><!-- /.item -->
		</div><!-- /.full-width-slider -->
		...
		<div class="row">
			...
			<div class="hidden-md col-sm-4 col-lg-4">
				<div class="info-box">
					...
					<h6 class="text">envio gratis en pedidos mayores a 5 productos.</h6>	
				</div>
			</div><!-- .col -->
			...
			<div class="more-info-tab clearfix">
			   <h3 class="new-product-title pull-left">Productos Destacados</h3>
				<ul class="nav nav-tabs nav-tab-line pull-right" id="new-products-1">
					...
					<li><a href="#books" data-toggle="tab">Collares</a></li>
					<li><a href="#furniture" data-toggle="tab">Camas</a></li>
				</ul><!-- /.nav-tabs -->
			</div>
				...
				<div class="row">
					<div class="col-md-6">
	                   <section class="section">
	                   	<h3 class="section-title">Comida de Mascota</h3>
...
<?php }?>
					...
					<div class="col-md-6">
						<section class="section">
							<h3 class="section-title">Cuidado Animal</h3>
		                   	<div class="owl-carousel homepage-owl-carousel custom-carousel outer-top-xs owl-theme" data-item="2">
	<?php
